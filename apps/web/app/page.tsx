    ...
    <div className='min-h-screen bg-black text-white font-sans overflow-x-hidden'>
      ...
      <nav className='flex justify-between items-center p-6 sticky top-0 bg-black/80 backdrop-blur-md z-40 border-b border-zinc-800 gap-4'>
        ...
        <div className='flex gap-4 items-center'>
          ...
          {/* 👥 AUTH TOGGLES FOR SIGNED OUT USERS */}
          <SignedOut>
            <div className='flex items-center gap-3'>
              <a
                href='/sign-in'
                className='text-zinc-300 hover:text-white font-bold text-sm px-4 py-2 rounded-full transition'
              >
                Sign In
              </a>
              <a
                href='/sign-up'
                className='bg-red-600 hover:bg-red-700 text-white font-bold text-sm px-5 py-2.5 rounded-full shadow-md transition'
              >
                Sign Up
              </a>
            </div>
